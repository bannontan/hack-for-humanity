...
const CreateRequest = () => {
	...
	return (
		<div className="create-request-page">
			{!isSubmitted && <h1>Hello {user?.username}!</h1>}
			...
			{!isSubmitted ? (
				...
				<div className="success-screen">
					...
					<p>
						Don't worry, the relevant support teams will come and
						help you/reach out to you. In the meantime, stay
						protected. Here are some helpline numbers:
					</p>
